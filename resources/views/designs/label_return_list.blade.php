...
<div class="pages purchase-orders">
    <section class="main-header">
        <div class="section-breadcrumb">
            <ul>
                ...
                <li>/</li>
                <li>
                    <a href="{{url('/label-return')}}">Label Returns</a>
                </li>
                <li></li>
            </ul>
        </div>
    ...
    @include('components.tables.label_return_filter')
    <section class="table-content">        
        @include('components.tables.label_return_table')
    </section>
</div>

    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="popup-form formFieldInput" id="product_form" autocomplete="off">
                    <div class="mb-3">
                        <input type="hidden" name="id">
                        <input type="hidden" name="issued_qty" value="0">
                    ...
                    <div class="py-3 text-end">
                        ...
                        <button type="submit" class="btn apply-btn product-popup-save-btn" disabled>Add</button>
                    </div>
                </form>
            </div>
        </div>

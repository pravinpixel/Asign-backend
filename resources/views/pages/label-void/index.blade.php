...
@section('content')
    <div class="pages customers-list">
        <section class="main-header">
            <div class="section-title">
                <h4>Label Void<span id="total">(<span id="total_count">{{ $total }}</span> Voids)</span></h4>
            </div>
        @php($filters = [['id' => 'all', 'text' => 'All', 'value' => ''], ['id' => 'location_id', 'text' => 'Location', 'value' => 'location_id']])
        <div class="section-filter-1 filter-index">
            ...
            <div id="filter_panel" class="close">
                <div class="row filter-focus mt-3 mb-2">
                    ...
                    <div class="col-sm-12 col-md-3 custom_select_1">
                        <select multiple="multiple" placeholder="Select Agent" name="agent_id" class="custom_select">
    ...
    <section class="table-content">
        <table class="asign-table customer-table customer" id="master_table">
            <thead>
                <tr>
                    <th width="25%" scope="col" class="has_sort" data-value="location_id">Location</th>
                    <th width="25%" scope="col" class="has_sort" data-value="agent_id">Agent</th>
                    <th width="25%" scope="col" class="has_sort" data-value="envelope_code">Envelop Id</th>
                    <th width="25%" scope="col" class="has_sort" data-value="label_code">Label</th>
                    <th width="25%" scope="col" class="has_sort" data-value="void_remarks">Remarks</th>
                </tr>
                </thead>
            <tbody class="tbody-detail">
                @include('pages.label-void.table')
            </tbody>
        </table>
    </section>
  ...
  $(document).ready(function () {
    $('.clear-all').hide();
        ...
        function search() {
            ...
            let product_id = $('select[name="agent_id"]').val();
            let data = {

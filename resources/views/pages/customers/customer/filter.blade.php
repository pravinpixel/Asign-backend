    ...
    <div class="filter-setup">
        ...
        <div class="dropbar-bar">
            ...
            <ul class="dropdown-menu">
                <li><a id="export_button" class="dropdown-item export-link">Export</a></li>
            </ul>
        </div>
    </div>
    <div id="filter_panel" class="close">
        <div class="row filter-focus mt-3 mb-2">
            <div class="col-sm-12 col-md-3 verifylogin" id="verifylogin">
                <select multiple="multiple" placeholder="Select Login Status" class="custom_select status_select" id="login_status">
                    <option value="1" data-badge="">
                        Logged In
                    </option>
            ...
            <div class="col-sm-12 col-md-3" id="verifytype">
                <select multiple="multiple" placeholder="Select Type" class="custom_select" name="type" id="type">
                    <option value="artist" data-badge="">Artist</option>
                    <option value="business" data-badge="">
                        Business
                    </option>
                    <option value="collector" data-badge="">
                        Collector
                    </option>
                </select>
            </div>
            <div class="col-sm-12 col-md-3" id="verifycity">
            ...
            <div class="col-sm-12 col-md-3 mt-3" id="sortByPercentage">

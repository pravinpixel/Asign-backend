...
<div class="pages customers-list">
    <section class="main-header">
        ...
        <div class="section-title">
            <h4>Collectors <span id="total"></span></h4>
        </div>
    </section>
...
<script>
    $('#export_button').click(function() {
        ...
        $.ajax({
            url: "{{route('export.collector.export')}}",
            type: 'GET',
            data: {
                login: login,
                city: city,
...
<script type="text/javascript">
    var url = "{{url('customer/collector/list')}}";
    var view_url = "{{url('customer/collector')}}/";
</script>

        ...
        <section class="table-content">
            <table class="asign-table purchase-order-table">
                ...
                <tr>
                    ...
                    <th scope="col" class="has_sort" data-value="artwork_id" width="15%">Artwork</th>
                    <th scope="col" class="has_sort" data-value="customer_id" width="20%">Customer</th>
                    <th scope="col" class="has_sort" data-value="price" width="15%">Price</th>
                    <th scope="col" class="has_sort" data-value="offer_price" width="20%">Offer Price</th>
                    <th scope="col" class="has_sort" data-value="status" width="15%">STATUS</th>
                </tr>
                </thead>
                <tbody id="tableCtr" class="tbody-detail">

                @include('pages.artwork_request.offer_request.tab')
                </tbody>
            </table>
        </section>
        {{--        table end --}}
...
<script>
    ...
    function search() {
        ...
        $.ajax({
            url: "{{ route('image-request.offerRequestList') }}" ,
            type: "GET",
            data: data,

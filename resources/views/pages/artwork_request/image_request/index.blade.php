    ...
    <div class="pages purchase-orders">
        ...
        <section class="table-content">
            <table class="asign-table purchase-order-table">
                <thead>
                <tr>
                    <th scope="col" class="has_sort" data-value="request_id" width="20%">Request ID</th>
                    <th scope="col" class="has_sort" data-value="artwork_id" width="20%">Artwork</th>
                    <th scope="col" class="has_sort" data-value="customer_id" width="20%">Customer</th>
                    <th scope="col" class="has_sort" data-value="image_ids" width="20%">Images</th>
                    <th scope="col" class="has_sort" data-value="status" width="20%">STATUS</th>
                </tr>
                </thead>
                <tbody id="tableCtr" class="tbody-detail">

                @include('pages.artwork_request.image_request.tab')
                </tbody>
            </table>
        </section>
        {{--        table end --}}
...
<script>
    ...
    function search() {
        ...
        $.ajax({
            url: "{{ route('image-request.imageRequestList') }}" ,
            type: "GET",
            data: data,

...
<div class="form-group mb-3">
    ...
    <input type="text" class="form-control" placeholder="Enter Time Zone Name" name="name" value="{{ $info->name ?? '' }}">
 <span class="field-error" id="name-error"></span>
</div>

<div class="form-group mb-3">
    <label class="form-label"> Value:</label>
    <input type="text" class="form-control" placeholder="Enter Value" name="value" value="{{ $info->value ?? '' }}">
 <span class="field-error" id="name-error"></span>
</div>

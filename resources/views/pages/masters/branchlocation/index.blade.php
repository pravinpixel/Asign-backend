...
<section class="main-header">
    <div class="section-breadcrumb">
            ...
            <li>
                <a href="{{url('masters/branch-office')}}">Asign Location</a>
            </li>
            <li>
            </li>
        </ul>
     ...
     <div class="section-title">
        <h4>Asign Location<span id="total"></span></h4>
    </div>
    <!-- #....Header -->
<!-- #...search -->
<!-- #...end search -->
  ...
  <div class="filter-setup">
    <div class="search-bar">
      <div class="input-group filter-with">
        ...
        <ul class="dropdown-menu width-ul">
          ...
          <li class="li-one  padding-li">
            <div class="custom-check">
              <input class="form-check-input" type="radio" name="flexRadioDefault1" id="location" value="location" checked>
        ...
        <input type="text" placeholder="Search location" class="form-control" aria-label="Text input with dropdown button" id="search" name="search">
      </div>
    </div>
    ...
    <div class="dropbar-bar" @if (!access()->hasAccess('master.create'))  data-toggle="tooltip" data-placement="bottom" title="You don’t have Create permission" 
      ...
      <button type="button" class="btn cancel-btn" id="add" onclick="getModal()"  @if (!access()->hasAccess('master.create')) disabled @endif>
        <img src="{{ asset('icons/add.png') }}">  Add Asign Location
        </button>
    </div>
  </div>
        ...
        <thead>
            <tr>
              <th scope="col" width="20%" >SR NO.</th>
                <th scope="col" width="15%" class="has_sort" data-value="location">Location</th>
...
<script type="text/javascript">
  var url="{{ url('masters/branch-office/list') }}";
  var edit="{{ asset('icons/edit-2.png') }}";
  var edit_model="{{ route('branch-office.add_edit') }}";
    var save_model = "{{ route('branch-office.save') }}";
    var check="{{ route('branch-office.check') }}";
    var delete_icon = "{{ asset('icons/image_2024_01_24T04_03_24_643Z.png') }}";
  var delete_url="{{ route('branch-office.delete') }}";
</script>
 <script type="text/javascript" src="{{ asset('js/masters/branchlocation.js') }}"></script>
@endpush

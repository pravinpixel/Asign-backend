...
<section class="main-header">
    <div class="section-breadcrumb">
            ...
            <li>
                <a href="{{url('masters/surface-type')}}">Surface Type</a>
            </li>
            <li>
            </li>
        </ul>
     ...
     <div class="section-title">
        <h4>Surface Type<span id="total"></span></h4>
    </div>
    <!-- #....Header -->
<!-- #...search -->
  ...
  <div class="filter-setup">
    ...
    <div class="dropbar-bar" @if (!access()->hasAccess('master.create'))  data-toggle="tooltip" data-placement="bottom" title="You don’t have Create permission" 
      ...
      <button type="button" class="btn cancel-btn" id="add" onclick="getModal()"  @if (!access()->hasAccess('master.create')) disabled @endif>
        <img src="{{ asset('icons/add.png') }}">         Add Surface Type
        </button>
    </div>
  </div>
        ...
        <thead>
            <tr>
              <th scope="col" width="20%" >SR NO.</th>
                ...
                <th scope="col" width="30%" class="has_sort" data-value="type">Type</th>
...
<script type="text/javascript">
  var url="{{ url('masters/surface-type/list') }}";
  var edit="{{ asset('icons/edit-2.png') }}";
  var edit_model="{{ route('surface-type.add_edit') }}";
  var save_model="{{ route('surface-type.save') }}";
  var check="{{ route('surface-type.check') }}";
  var delete_icon = "{{ asset('icons/image_2024_01_24T04_03_24_643Z.png') }}";
  var delete_url="{{ route('surface-type.delete') }}";
</script>
 <script type="text/javascript" src="{{ asset('js/masters/surfacetype.js') }}"></script>
@endpush

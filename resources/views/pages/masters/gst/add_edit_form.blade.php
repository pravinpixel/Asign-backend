...
<div class="form-group mb-3">
    ...
    <input type="text" class="form-control" placeholder="Enter GST Name" name="name" value="{{ $info->name ?? '' }}">
 <span class="field-error" id="name-error"></span>
</div>
<div class="form-group mb-3">
    <label class="form-label"> Percentage :</label>
    <input type="text" class="form-control" placeholder="Enter Percentage " name="percentage" value="{{ $info->percentage  ?? '' }}">
 <span class="field-error" id="percentage-error"></span>
</div>

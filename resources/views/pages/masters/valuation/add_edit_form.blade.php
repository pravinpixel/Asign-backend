...
<div class="form-group mb-3">
  <label class="form-label">Valuation {{ ucfirst($tag) }} Name:</label>
    <input type="text" class="form-control" placeholder="Valuation {{ ucfirst($tag) }} Name" name="name" value="{{ $info->name ?? '' }}">

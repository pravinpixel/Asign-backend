...
<div class="form-group mb-3">
    ...
    <input type="text" class="form-control" placeholder="Enter Price From" name="price_from" value="{{ $info->price_from ?? '' }}">
 <span class="field-error" id="price_from-error"></span>
</div>
<div class="form-group mb-3">
    <label class="form-label">Price To:</label>
    <input type="text" class="form-control" placeholder="Enter Price To" name="price_to" value="{{ $info->price_to ?? '' }}">
 <span class="field-error" id="price_to-error"></span>
</div>
<div class="form-group mb-3">

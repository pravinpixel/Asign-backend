...
<section class="main-header">
    <div class="section-breadcrumb">
            ...
            <li>
                <a href="{{url('masters/object-condition')}}">ObjectCondition</a>
            </li>
            <li>
            </li>
        </ul>
     ...
     <div class="section-title">
        <h4>ObjectCondition<span id="total"></span></h4>
    </div>
    <!-- #....Header -->
<!-- #...search -->
  ...
  <div class="filter-setup">
    ...
    <div class="dropbar-bar" @if (!access()->hasAccess('master.create'))  data-toggle="tooltip" data-placement="bottom" title="You don’t have Create permission" 
      ...
      <button type="button" class="btn cancel-btn" id="add" onclick="getModal()"  @if (!access()->hasAccess('master.create')) disabled @endif>
        <img src="{{ asset('icons/add.png') }}">         Add ObjectCondition
        </button>
    </div>
  </div>
    ...
    <table class="asign-table customer-table customer" id="master_table">
        <thead>
            <tr>
              ...
              <th scope="col" width="30%" class="has_sort" data-value="question">Question</th>
               <th scope="col" width="30%" class="has_sort" data-value="answer_type">Answer Type</th>
...
<script type="text/javascript">
  var url="{{ url('masters/object-condition/list') }}";
  var edit="{{ asset('icons/edit-2.png') }}";
  var edit_model="{{ route('object-condition.add_edit') }}";
  var save_model="{{ route('object-condition.save') }}";
  var check="{{ route('object-condition.check') }}";
  var delete_icon = "{{ asset('icons/image_2024_01_24T04_03_24_643Z.png') }}";
  var delete_url="{{ route('object-condition.delete') }}";
</script>
 <script type="text/javascript" src="{{ asset('js/masters/object-condition.js') }}"></script>
@endpush

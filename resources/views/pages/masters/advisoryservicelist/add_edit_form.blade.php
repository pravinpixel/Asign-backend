...
<div class="form-group mb-3">
    ...
    <input type="text" class="form-control" placeholder="Enter code " name="code" value="{{ $info->code ?? '' }}">
 <span class="field-error" id="code-error"></span>
</div>
<div class="form-group mb-3">
    <label class="form-label">Title:</label>
    <input type="text" class="form-control" name="title" placeholder="Enter title " value="{{ $info->title ?? '' }}">
<span class="field-error" id="title-error"></span>
</div>
<div class="form-group mb-3">
    <label class="form-label">Cost:</label>
    <input type="text" class="form-control" placeholder="Enter cost " name="cost" value="{{ $info->cost ?? '' }}">
 <span class="field-error" id="cost-error"></span>
</div>

<div class="form-group mb-3">
    <label class="form-label">Description:</label>
    <textarea   class="form-control" placeholder="Enter description " name="description" value="" >{{ $info->description ?? '' }}</textarea>

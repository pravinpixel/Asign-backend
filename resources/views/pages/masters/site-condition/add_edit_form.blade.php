        ...
        <div class="form-group">
              ...
              <div class="w100Select">
                <select class="select2Box"  name="question">
                  <option value=""></option>
                  <option value="physical_space"  @if(isset($info->question) && $info->question == 'physical_space') selected @endif>Physical Space</option>
                <option value="site_accessible" @if(isset($info->question) && $info->question == 'site_accessible') selected @endif >Site Accessible</option>
                <option value="lighting_adequate" @if(isset($info->question) && $info->question == 'lighting_adequate') selected @endif >Lighting Adequate</option>
                <option value="surrounding_work_space" @if(isset($info->question) && $info->question == 'surrounding_work_space') selected @endif >Surrounding Work Space</option>
            </select>
              </div>
            </div>
        </div>

    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="popup-form formFieldInput" id="product_modal" autocomplete="off">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="py-3 text-end">
                        <button class="btn cancel-btn mx-2 product-popup-cancel-btn" type="reset">Cancel</button>

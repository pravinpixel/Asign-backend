    ...
    <div class="pages purchase-order-create">
        ...
        <section class="m-header">
            ...
            @if( !empty( $stoData['stock_transfer_order_products'] ) )
                @foreach ( $stoData['stock_transfer_order_products'] as $sto_product )
                    @if( $sto_product['grn_quantity_currently_scanned_products'] > 0 )
                    ...
                    <div class="col col-md-6">
                        <div class="row">
                            <div class="col col-md-10">
                                ...
                                <input type="text" class="form-control form-control-lg gray-colour" name="grn_no"
                        ...
                        <div class="row">
                            <div class="col col-md-10">
                                ...
                                <div class="w100Select">
                                    <input type="text" class="form-control form-control-lg gray-colour" name="order_no"
                                    placeholder="Grn no" value={{ $stoData['sto_no'] }} readonly>
                                ...
                                <div class="w100Select">
                                    <select class="select2Box" data-placeholder="Select GRN Location" name="grn_location"
                                        ...
                                        @foreach ($grn_locations as $location)
                                            ...
                                            {{
                                                $location['id'] == $stoData->stock_destination_id ? 'selected' : ''
                                            }}
                        ...
                        <div class="row">
                            <div class="col col-md-10 input-addon addon-right">
                                ...
                                <input type="text" class="datepicker form-control form-control-lg" name="created_on"
                                    id="order_date" placeholder="Select" value="{{ $stoData->created_date }}" readonly>
                            ...
                            <div class="col col-md-10">
                                ...
                                <div class="w100Select">
                                    <select class="select2Box" data-placeholder="Select Sender Name" id="sender" name="sender_name">
                                        ...
                                        <option value={{ $location['id'] }}
                                        {{
                                            $location['id'] == $stoData->stock_source_id ? 'selected' : ''
                                        }}
                                        >{{ $location['location'] }}</option>
                                    @endforeach
                                    </select>
                    ...
                    <div class="col col-md-6">
                        <div class="row">
                            <div class="col col-md-10">
                                ...
                                <div class="w100Select">
                                    <select class="select2Box" data-placeholder="Select Transporter Name" id="sto_grn_transporter" name="transporter_name">
                                        <option></option>
        ...
        <section class="table-content">
            @include('pages.stock_management.stock_transfer_order.sto_grn_table')
        </section>
    </div>
@endsection
@push('scripts')

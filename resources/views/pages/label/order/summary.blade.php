    ...
    <div class="pages purchase-order-summary">
        ...
        <section class="section-inner">
            ...
            <ul class="personal-info">
                <li>
                    <span>PO No.</span>
                    <span>{{ $purchase_order->order_no }}</span>
                </li>
                <li>
                ...
                <li>
                    ...
                    <span>{{ $purchase_order->location?->location }}</span>
                </li>
                <li>
        ...
        <section class="table-content">
            @include('pages.label.order.tables.summary_table')
        </section>
    </div>
@endsection
@push('scripts')

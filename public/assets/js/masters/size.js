$(document).ready(function() {
    ...
    function myfunction(per_page, page, search, search_key) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#total').append('(' + response.data.total + ' sizes)');
                ...
                response.data.data.forEach(function(row) {
                    ...
                    <tr id='${sr_no}'>
                        ...
                        <td><p>${row.tag}</p></td>
                        <td><p>${row.size_from}</p></td>
                        <td><p>${row.size_to}</p></td>
    ...
    $('#selcted_radio').append('Tag');
    $("input[name=search]").attr("placeholder", "Search Tag");
    $('input[name=flexRadioDefault1]').on("click", function() {
        ...
        if (this.value == 'all') {
            ...
            name = 'Tag';
            $("input[name=search]").attr("placeholder", "Search Tag");
        } else if (this.value == 'size_from') {
            name = 'Size From';
            $("input[name=search]").attr("placeholder", "Search Size From");
        } else if (this.value == 'size_to') {
            name = 'Size To';
            $("input[name=search]").attr("placeholder", "Search Size To");
        } 

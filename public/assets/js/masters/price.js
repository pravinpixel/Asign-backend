$(document).ready(function() {
            ...
            success: function(response) {
                ...
                response.data.data.forEach(function(row) {
                    ...
                    <tr id='${sr_no}'>
                        ...
                        <td><p>${row.price_from}</p></td>
                        <td><p>${row.price_to}</p></td>
    ...
    $('#selcted_radio').append('Price From');
    $("input[name=search]").attr("placeholder", "Search Price From");
    $('input[name=flexRadioDefault1]').on("click", function() {
        ...
        } else if (this.value == 'price_from') {
            name = 'Price From';
            $("input[name=search]").attr("placeholder", "Search Price From");
        } else if (this.value == 'price_to') {
            name = 'Price To';
            $("input[name=search]").attr("placeholder", "Search Price To");
        } 

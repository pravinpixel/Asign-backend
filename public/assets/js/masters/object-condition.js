    ...
    function myfunction(per_page, page, search, search_key) {
        ...
        $.ajax({
            ...
            success: function(response) {    
                ...
                $('#total').append('(' + response.data.total + ' ObjectConditions)');
                ...
                response.data.data.forEach(function(row) {
                    ...
                    if (row.question == 'object_match') {
                        var question = 'Object Match';
                    } else if (row.question == 'damage') {
                        var question = 'Damage';
                    } else if (row.question == 'asign_protect+') {
                        var question = 'Asign Protect+';
                    } else {
                        var question = 'Surface Condition';
                    }                    

    ...
    function myfunction(per_page, page, search, search_key) {
        ...
        $.ajax({
            ...
            success: function(response) {    
                ...
                $('#total').append('(' + response.data.total + ' SiteConditions)');
                ...
                response.data.data.forEach(function(row) {
                    ...
                    if (row.answer_type == 'yes') {
                        var answer_type = 'Yes';
                    } else {
                        var answer_type = 'No';
                    }
                    if (row.question == 'physical_space') {
                        var question = 'Physical Space';
                    } else if (row.question == 'site_accessible') {
                        var question = 'Site Accessible';
                    } else if (row.question == 'lighting_adequate') {
                        var question = 'Lighting Adequate';
                    } else {
                        var question = 'Surrounding Work Space';
                    }                    

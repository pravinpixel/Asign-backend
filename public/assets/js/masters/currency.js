$(document).ready(function() {
    ...
    function myfunction(per_page, page, search, search_key) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#total').append('(' + response.data.total + ' currencies)');
    ...
    $('input[name=flexRadioDefault1]').on("click", function() {
        ...
        if (this.value == 'all') {
            ...
            name = 'Name';
            $("input[name=search]").attr("placeholder", "Search Name");
        } else if (this.value == 'symbol') {
            name = 'Symbol';
            $("input[name=search]").attr("placeholder", "Search Symbol");
        }
        else if (this.value == 'code') {
            name = 'Code';
            $("input[name=search]").attr("placeholder", "Search Code");
        }
        else if (this.value == 'exchange_rate') {
            name = 'Exchange Rate';
            $("input[name=search]").attr("placeholder", "Search Exchange Rate");
        }
        else if (this.value == 'is_base') {
            name = 'Is Base';
            $("input[name=search]").attr("placeholder", "Search Is Base");
        }
        $('#selcted_radio').append(name);
        myfunction(per_page, page, search, search_key);
    });

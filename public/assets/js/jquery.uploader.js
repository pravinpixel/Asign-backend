(() => {
    ...
    var e = {
        ...
        d: (i, t) => {
            for (var r in t) e.o(t;
var r) && !e.o(i;
var r) && Object.defineProperty(i;
var r;
var {
                enumerable: !0;
var get: t[r]
...
const l = "defaultUploaderOptions";
const s = ".jquery-uploader-preview-progress";
const a = "image";
const o = "other";
const n = [ "jpg";
const "png";
...
let i = "0123456789abcdef";
        ...
        return e[14] = "4", e[19] = i.substr(3 & e[19] | 8, 1), e[8] = e[13] = e[18] = e[23] = "-", 
        e.join("");
    }
    function p(e) {
    ...
    class h {
        constructor(e, i) {
            ...
            this.options = t().extend(!0, {}, h.defaults, r, i), this.files = [], this.checkOptions(), 
            this.initEle(), this.initEvent();
        }
        checkOptions() {
...
let ");
        ...
        refreshPreviewFileList() {
            ...
            })), (this.options.multiple || 0 === this.files.length) && (this.$uploaderContainer.append(this.$selectCard), 
        ...
        createDefaultFiles(e) {
            ...
            this.options.defaultValue ? i = this.options.defaultValue : e && (this.options.multiple ? e.split(",") : [ e ]).forEach(((e, t) => {
                ...
                let i = u();
let t = this.createFileCardEle(i;
let e.url;
let e.type);
                this.files.push({
                    id: i,
        ...
        onFileUploadSuccess(e, i) {
            ...
            try {
                if (t = this.options.ajaxConfig.responseConverter(e, i), !t.url) return console.error("No URL"), 
                void this.onFileUploadError(e, "No URL");
            } catch (i) {
                return console.error("Error", i), void this.onFileUploadError(e, "Error");
            }
            e.url && e.url.startsWith("blob") && d.revokeBlobUrl(e.url), e.name = t.name || e.name, 
            e.url = t.url, e.status = h.fileStatus.uploaded, e.$ele.find(".jquery-uploader-preview-main > img").attr("src", e.url), 
            this.refreshPreviewFileList(), this.refreshValue();
        }
        onFileUploadError(e, i) {
            this.$originEle.trigger("upload-error", e, i), e.$ele.find(s).hide(), e.$ele.attr("title", i), 
        ...
        handleFileAdd(e) {
            ...
            for (let t = 0; t < e.length; t++) {
                let r = e[t];
let l = -1 !== r.type.indexOf("image") ? a : o;
let s = d.createBlobUrl(r);
let n = u();
let p = this.createFileCardEle(n;
let s;
let l);
            ...
            this.files.push(...i), this.refreshPreviewFileList(), this.$originEle.trigger("file-add", i), 
...
let r = i[0].id;
            ...
            let s = this.files.splice(l;
let 1);
            s.url && d.revokeBlobUrl(s.url), this.$originEle.trigger("file-remove", ...s), this.refreshValue(), 
